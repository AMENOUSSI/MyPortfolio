<template>
    ...
    overflow-hidden">
        ...
        v-motion="'custom'" :initial="{ opacity: 0, y: 100 }"
            :visible="{ opacity: 1, y: 0 }" :variants="{ custom: { scale: 2 } }">
            <div class="flex flex-col md:flex-row items-center h-full pt-8">
                <!-- <div class="flex lg:flex flex-1 justify-start items-end h-full">
                    <img src="/img/hero.jpg" alt="Image">
                </div> -->
                <div class="flex-1 flex flex-col items-center lg:items-start">
                    <p class="text-lg text-accent text-md mb-[22px]">Hey, I'm Jules!</p>
                    <h1
                        class="text-4xl leading-[44px] md:text-5xl md:leading-light lg:text-7xl lg:leading-[1.2] font-bold md:tracking-[-2px]">
                        I Build & Design <br> Web Interfaces.
                    </h1>
                    <p class="pt-4 pb-8 md:pt-6 md:pb-12 max-w-[480px] text-lg text-center lg:text-left">
                        I  am software engineer student developer. I builder websites, web apps and design in general. 
                    </p>
                    <button
                        class="btn btn-md bg-accent hover:bg-light-secondary hover:text-light-tail-500 md:btn-lg transition-all">
                        Work with me
                    </button>
                    <div class="pt-12">
                        <h5 class="text-lg flex items-center text-black dark:text-white justify-center lg:justify-start mb-2 ">
                            Follow me on
                        </h5>
                        <div class="flex items-center mb-6">
                            ...
                            mr-3 sm:mr-4"
                                href="https://m.facebook.com/search/top/?q=ablam%20jules%20amenoussi&tsid=0.645070914935906&source=result">
                            ...
                            dark:hover:border-secondary 
                            mr-3 sm:mr-4"
                                href="https://www.linkedin.com/in/ablam-jules-amenoussi-218644270/">
                            ...
                            dark:hover:border-secondary 
                            mr-3 sm:mr-4"
                                href="https://github.com/AMENOUSSI">
                ...
                <div class="flex lg:flex flex-1 justify-end items-center h-full mt-8 md:mt-0">

                <img class="rounded-lg" src="/img/jules1.jpg" alt="Image">
            </div>
        </div>
    </div>
</section></template>
